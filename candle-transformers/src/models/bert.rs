...
use candle::{DType, Device, Result, Tensor, AttentionModule};
...
impl AttentionModule for BertSelfAttention {
...
impl AttentionModule for BertAttention {
    fn forward(&self, hidden_states: &Tensor, attention_mask: &Option<Tensor>) -> Result<Tensor> {
        let _enter = self.span.enter();
...
impl AttentionModule for BertLayer {
    fn forward(&self, hidden_states: &Tensor, attention_mask: &Option<Tensor>) -> Result<Tensor> {
        let _enter = self.span.enter();
...
impl AttentionModule for BertEncoder {
    fn forward(&self, hidden_states: &Tensor, attention_mask: &Option<Tensor>) -> Result<Tensor> {
        let _enter = self.span.enter();
